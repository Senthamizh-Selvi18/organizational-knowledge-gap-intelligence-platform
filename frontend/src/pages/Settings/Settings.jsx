  ...
  return (
    <DashboardLayout>
      <div className="h-full flex flex-col">
        <div className="flex-1 overflow-y-auto space-y-6 p-6 lg:p-8">
          {/* Header */}
        ...
        {/* Save / Cancel — now static, always at the bottom, never scrolls */}
        <div className="shrink-0 border-t border-line bg-bg/95 px-6 py-4 backdrop-blur-xl lg:px-8">
