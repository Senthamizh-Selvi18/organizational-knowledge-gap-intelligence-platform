...
export default function ChatBox() {
  ...
  return (
    <DashboardLayout>
      {/*
        `<main>` in DashboardLayout is already a flex-1 item that gets
        stretched to exactly fill the space next to the Navbar — so we just
        need to consume 100% of that here, not recompute our own guess at
        the height from 100vh. Using h-full (rather than a second
        calc(100vh-Npx)) means this stays correct across the compact vs.
        comfortable layout modes and any navbar height changes, since it's
        no longer a second independent number that has to match the first.
      */}
      <div className="flex h-full min-h-[600px] flex-col">
        ...
        <div className="flex min-h-0 flex-1 overflow-hidden rounded-2xl border border-line bg-panel shadow-card">
